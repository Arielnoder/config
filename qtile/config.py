...
myBrowser = "rofi -combi-modi window,drun,ssh  -show combi -show-icons" 
...
colors = [["#282a36", "#282a36"], # panel background
          ...
          ["#282a36", "#282a36"], # font color for group names
          ["#44475a", "#44475a"], # border line color for current tab
          ["#ecbbfb", "#ecbbfb"], # border line color for 'other tabs' and color for 'odd widgets'
